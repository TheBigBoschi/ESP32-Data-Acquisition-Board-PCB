...
Particular care has been taken to properly decouple the ESP32 power supply, as a switching regulator is often too slow to react to the sudden bursts of energy required by the ESP32 transmitting data, and various capacitor have been added to provide instantaneous power for it.
